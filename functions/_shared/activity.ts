...
export const ACTION_LABELS: Record<string, string> = {
  ...
  'social_account.connected': '連線 Threads 帳號',
  'social_account.reconnected': '重新連線 Threads 帳號',
  'social_account.revoked': '撤銷社群帳號連線',
  'social_account.removed': '移除 Threads 帳號',
  'social_account.primary_changed': '變更 Threads 主帳號',
  'social_safety.updated': '更新社群安全政策',
  'social_safety.org_paused': '開啟組織停止開關',
  'social_safety.org_resumed': '關閉組織停止開關',

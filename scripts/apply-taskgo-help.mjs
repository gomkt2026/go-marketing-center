#!/usr/bin/env node
/**
 * 從 .env 讀 DATABASE_URL，套用 TaskGo 客服文件 SQL。
 * 用法: node scripts/apply-taskgo-help.mjs
 */
...
const sqlFile = join(root, 'db/migrations/029_taskgo_help_documents.sql');

#!/usr/bin/env node
/**
 * 從 .env 讀 DATABASE_URL，套用 Washgo 客服文件 SQL。
 * 用法: node scripts/apply-washgo-help.mjs
 */
...
const sqlFile = join(root, 'db/migrations/031_washgo_help_documents.sql');
